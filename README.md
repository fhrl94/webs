...
- 2018.3.13 设置【admin】中表的中文名称，以及时区设置

- 2018.2.26 新增离职人员标识，离职人员不发邮件

- 2018.2.23 【历史记录】中直接下载表单，中去重

- 2018.2.22 解决上一个修改后的错误，新增【历史记录】中实现直接下载表单

- 2018.2.12 定时的任务调用异步bug，修复

- 2018.2.6 【进度列表-8】已完成

- 2018.1.31 【首次登录需要修改密码】、【定时发送邮件（需要 django-apscheduler 库）】
